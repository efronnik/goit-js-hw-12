import{a as c,S as u,i as m}from"./assets/vendor-64b55ca9.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))o(e);new MutationObserver(e=>{for(const s of e)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&o(a)}).observe(document,{childList:!0,subtree:!0});function r(e){const s={};return e.integrity&&(s.integrity=e.integrity),e.referrerPolicy&&(s.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?s.credentials="include":e.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function o(e){if(e.ep)return;e.ep=!0;const s=r(e);fetch(e.href,s)}})();const d="gallery-link";function f({largeImageURL:i,tags:t,webformatURL:r,likes:o,views:e,comments:s,downloads:a}){return`
  ...
  `}const g=document.querySelector("#gallery"),n=document.querySelector(".search-form"),l=document.querySelector(".loader"),p=document.querySelector(".no-results-message");n.addEventListener("submit",async function(i){i.preventDefault();const t=i.target.elements.query.value;if(t!==""){l.style.display="block";try{const r=await c.get(`https://api.unsplash.com/search/photos?query=${t}&client_id=42444504-9067092ee8fdaf17c241a1e97`),{results:o}=r.data;if(o.length>0){const e=o.map(f).join("");g.innerHTML=e,new u(`.${GALLERY_LINK}`).refresh()}else p.style.display="block"}catch(r){console.error("Error fetching images:",r),m.error({title:"Error",message:`Error fetching images: ${r.message}`,position:"topRight"})}finally{l.style.display="none",n.reset()}}});
